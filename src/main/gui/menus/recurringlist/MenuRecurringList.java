...
public class MenuRecurringList extends JFrame implements ActionListener {
    JButton create;
    JButton crossOff;
    JButton edit;
    JButton remove;
    ...
    public MenuRecurringList(User user) {
        // set up buttons
